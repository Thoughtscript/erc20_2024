...
3. Hard Hat [now uses ESM](https://hardhat.org/docs/migrate-from-hardhat2/guides/migrate-to-esm).
...
1. https://wizard.openzeppelin.com/#erc20
1. https://github.com/NomicFoundation/hardhat-ignition-examples/tree/main
1. https://moralis.io/ethers-js-tutorial-how-to-get-started-using-a-simple-ethers-js-example/
1. https://hardhat.org/docs/migrate-from-hardhat2/guides/migrate-to-esm
1. https://hardhat.org/docs/migrate-from-hardhat2